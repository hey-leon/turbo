...
class PreloaderTests extends TurboDriveTestCase {
    async "test preloads snapshot on initial load"() {
        await this.goToLocation("/src/tests/fixtures/preloading.html");
        this.assert.ok(await this.remote.execute(() => "http://localhost:9000/src/tests/fixtures/preloaded.html" in window.Turbo.session.preloader.snapshotCache.snapshots));
    }
...
exports.PreloaderTests = PreloaderTests;
